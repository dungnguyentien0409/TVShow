...
{
	public sealed class TVShowContext : DbContext
	{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:127.0.0.1,5433;Database=TVShow;User Id = SA;Password=MyPass@word;TrustServerCertificate=true");
            }
        }
    }
}
